...
-spec serialize_function_args(thrift_fun_full_ref(), list(term())) -> binary().
...
-spec deserialize_function_args(thrift_fun_full_ref(), binary()) -> list(term()).
...
-spec find_exception_name(thrift_type(), thrift_exception()) -> Name :: atom().
...
-spec do_find_exception_name(thrift_struct_def(), atom()) -> Name :: atom().
