...
merge_refund_change(?session_ev(?refunded(), ?session_started()), RefundSt) ->
    add_refund_session(create_refund_session(), RefundSt);
merge_refund_change(?session_ev(?refunded(), Change), RefundSt) ->
    update_refund_session(merge_refund_session_change(Change, RefundSt), RefundSt).

create_refund_session() ->
    create_session(?refunded(), undefined).
