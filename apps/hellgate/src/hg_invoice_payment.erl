...
make_refund(Params, Payment, Revision, St, Opts) ->
    ...
    ID = get_refund_id(Params, St),
    #domain_InvoicePaymentRefund {
        id              = ID, %Params#payproc_InvoicePaymentRefundParams.id,
...
get_refund_id(#payproc_InvoicePaymentRefundParams{id = undefined}, St) ->
    construct_refund_id(get_refunds(St));
get_refund_id(#payproc_InvoicePaymentRefundParams{id = ID}, _St) ->
    ID.
