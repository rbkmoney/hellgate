...
construct_invoice_template_details(undefined, _Cost) ->
    error({badarg, 'Product', undefined});
construct_invoice_template_details(_Product, undefined) ->
    error({badarg, 'Cost', undefined}).
