...
-spec handle_function_(woody:func(), list(), hg_woody_wrapper:handler_opts()) -> term() | no_return().
...
-spec init([invoice_tpl_id() | invoice_params()], hg_machine:machine()) -> hg_machine:result().
