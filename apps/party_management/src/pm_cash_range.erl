...
marshal(cash_bound, {Exclusiveness, Cash}) ->
    [marshal(exclusiveness, Exclusiveness), pm_cash:marshal(Cash)];
...
unmarshal(cash_bound, [Exclusiveness, Cash]) ->
    {unmarshal(exclusiveness, Exclusiveness), pm_cash:unmarshal(Cash)};
...
->
    {Exclusiveness, pm_cash:unmarshal([1, Cash])}.
