...
decode_varset(Varset, VS) ->
     VS#{
         ...
         payment_tool => prepare_payment_tool_var(
             Varset#payproc_Varset.payment_method, Varset#payproc_Varset.payment_tool),
...
encode_decode_test() ->
    Varset = #{
        ...
        payment_tool => {digital_wallet, #domain_DigitalWallet{
            provider = qiwi,
        ...
        p2p_tool => #domain_P2PTool{
            sender = {digital_wallet, #domain_DigitalWallet{
                provider = qiwi,
                id = <<"digital_wallet_id">>
            }},
            receiver = {digital_wallet, #domain_DigitalWallet{
                provider = qiwi,
                id = <<"digital_wallet_id">>
            }}
        },
